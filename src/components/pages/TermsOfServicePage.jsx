  ...
  return (
    <section id="terms-of-service">
      ...
      <div className="container">
        ...
        <div className="inter-def">
          ...
          <ol className="def-list">
            ...
            <li>
              ...
              &rdquo;Our&rdquo; in this Agreement) refers to Attila Software,
              LLC, 531 Grand Blvd, Kansas City MO, 64106.
            </li>
            ...
            <li>
              <strong>Website</strong> refers to baubau, accessible from{" "}
              <a
                className="website"
                href="https://www.baubau.space/"
                rel="noreferrer external nofollow noopener"
              >
                https://www.baubau.space/
              </a>
              .
            </li>
        ...
        <div className="linkstootherwebsites">
        ...
        <div className="limitofliability">
        ...
        <div className="asisdisclaimer">
          <h1>&rdquo;AS IS&rdquo; and &rdquo;AS AVAILABLE&rdquo; Disclaimer</h1>
          <p>
        ...
        <div className="countries">
          ...
          <p>
            ...
            &rdquo;terrorist supporting&rdquo; country, and (ii) You are not
        ...
        <div className="severability">
          ...
          <p>
            ...
            effect a party&rsquo;s ability to exercise such right or require
        ...
        <div className="contactus">
          ...
          <ul>
            <li>By email: chanon@baubau.space</li>
          </ul>
        </div>
      </div>
    </section>
